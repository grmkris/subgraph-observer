...
export type LinksQuery = { __typename?: 'Query', Links?: { __typename?: 'Links', hasNextPage?: boolean | null, hasPrevPage?: boolean | null, docs?: Array<{ __typename?: 'Link', id?: string | null, address?: string | null, content?: any | null } | null> | null } | null };
...
export type GetLinkQuery = { __typename?: 'Query', Link?: { __typename?: 'Link', id?: string | null, address?: string | null, content?: any | null } | null };
...
export type CreateLinkMutation = { __typename?: 'Mutation', createLink?: { __typename?: 'Link', id?: string | null, address?: string | null, content?: any | null, signature?: string | null } | null };
...
export const CreateLinkDocument = gql`
  ...
  createLink(data: {address: $address, content: $content, signature: $signature}) {
    id
    address
    content
    signature
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getLink(variables: GetLinkQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetLinkQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetLinkQuery>(GetLinkDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getLink', 'query');
    },
    createLink(variables: CreateLinkMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateLinkMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateLinkMutation>(CreateLinkDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createLink', 'mutation');
    }
  };
}
